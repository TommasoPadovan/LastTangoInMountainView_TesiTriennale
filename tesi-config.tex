...
\newcommand{\mainTitle}{Ultimo Tango a Mountain View}
\newcommand{\mySubTitle}{Ricostruzione 3D mediante dispositivi mobili Tango}
\newcommand{\myTitle}{\mainTitle, \mySubTitle}             
