...
\end{risk}
\begin{risk}{Prerequisiti dell'\emph{Area Learning}}
	\riskchance{Alta}
	\riskseverity{Alta}
    \riskdescription{Utilizzando l'\emph{Area Learning} il dispositivo ha necessità di un tempo di inizializzazione di circa 30-40 secondi in cui la stima della posizione è di fatto errata.}
    \risksolution{Durante l'inizializzazione devono essere fornite istruzioni per l'utente.}
