...
\hline
	RFO-3.1 &
	Il sistema deve essere in grado di fornire la lista di tutte le \emph{mesh}  salvati. &
	UC3.1\\
\hline
	RFO-3.2 &
...
\hline
	RFO-4.1.8 &
	L'interfaccia deve fornire un pulsante per permettere di passare alla visualizzazione dei file contenenti i \emph{Point Cloud}. &
	UC1.11 \\
\hline
	RFO-4.1.9 &
...
\hline
	RFO-4.1.16 &
	L'interfaccia deve fornire un pulsante per permettere il ritorno dalla lista delle \emph{mesh} all'\emph{activity} principale. &
	UC3.5 \\
\hline
	RFO-4.2 &
	L'interfaccia deve fornire delle statistiche riguardanti il \emph{Point Cloud} e la ricostruzione corrente in tempo reale. &
	UC1.7\\
\hline
	RFO-4.3 &
